      ...
      <div className="footer-con">
        <div className="footer-sub">
          <div className="Kep-info">
            ...
            <p>
              KEP.uz dasturlash mahoratlaringiz va raqobatni oshirish uchun
              moʻljanlangan platforma
            </p>
          </div>
          <div className="organish" style={{ fontSize: "13px", gap: "10px" }}>
            <li style={{ fontWeight: "bold" }}>
              ...
              <span style={{ marginLeft: "5px" }}>O'rganish</span>
            </li>
            <li>Kurslar</li>
            <li>Bloglar</li>
            <li>Lugavar</li>
          ...
          <div className="Ishlash" style={{ fontSize: "13px", gap: "10px" }}>
            <li style={{ fontWeight: "bold" }}>
              {" "}
              <span style={{ marginLeft: "5px" }}>Ishlash</span>
            </li>
            <li>Masalalar</li>
            <li>Bellashuvlar</li>
            <li>Testlar</li>
          ...
          <div className="musobaqa" style={{ fontSize: "13px", gap: "10px" }}>
            <li style={{ fontWeight: "bold" }}>
              ...
              <span style={{ marginLeft: "5px" }}>Musobaqalar</span>
            </li>
            <li>Kontestlar</li>
            <li>Arena</li>
            <li>Turnirlar</li>
